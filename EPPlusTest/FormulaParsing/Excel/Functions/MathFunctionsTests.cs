...
namespace EPPlusTest.Excel.Functions
{
    ...
    public class MathFunctionsTests
    {
        ...
        public void PiShouldReturnPIConstant()
        {
            ...
            Assert.That(expectedValue, Is.EqualTo(result.Result));
        }
        ...
        public void AsinShouldReturnCorrectResult()
        {
            ...
            Assert.That(expectedValue, Is.EqualTo(rounded));
        }
        ...
        public void CeilingShouldRoundTowardsZeroIfSignificanceAndNumberIsMinus0point1()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.Equals(expectedValue, System.Math.Round((double)result.Result, 2));
        }
        ...
        public void SumSqShouldCalculateArray()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(20d, Is.EqualTo(result.Result));
        }
        ...
        public void SumSqShouldIncludeTrueAsOne()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(21d, Is.EqualTo(result.Result));
        }
        ...
        public void StdevPShouldCalculateCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.Equals(0.8165d, Math.Round((double)result.Result, 5));
        }
        ...
        public void ExpShouldCalculateCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.Equals(54.59815003d, System.Math.Round((double)result.Result, 8));
        }
        ...
        public void AverageShouldThrowDivByZeroExcelErrorValueIfEmptyArgs()
        {
            ...
            Assert.That(eErrorType.Div0, Is.EqualTo(errorType));
        }
        ...
        public void AverageAShouldCountValueAs0IfNonNumericTextIsSuppliedInArray()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.Equals(1.5d,result.Result);
        }
        ...
        public void RoundShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(2.343d, Is.EqualTo(result.Result));
        }
        ...
        public void RoundShouldReturnCorrectResultWhenNbrOfDecimalsIsNegative()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(9000d, Is.EqualTo(result.Result));
        }
        ...
        public void FloorShouldReturnCorrectResultWhenSignificanceIsBetween0And1()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(26.7d, Is.EqualTo(result.Result));
        }
        ...
        public void FloorShouldReturnCorrectResultWhenSignificanceIs1()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(26d, Is.EqualTo(result.Result));
        }
        ...
        public void RandShouldReturnAValueBetween0and1()
        {
            ...
            Assert.That(((double)result1.Result) > 0 && ((double) result1.Result) < 1);
            var result2 = func.Execute(args, _parsingContext);
            Assert.That(result1.Result, Is.Not.EqualTo(result2.Result), "The two numbers were the same");
            Assert.That(((double)result2.Result) > 0 && ((double)result2.Result) < 1);
        }
        ...
        public void ProductShouldMultiplyArguments()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(16d, Is.EqualTo(result.Result));
        }
        ...
        public void ProductShouldHandleEnumerable()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(32d, Is.EqualTo(result.Result));
        }
        ...
        public void VarShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.Equals(1.6667d, System.Math.Round((double)result.Result, 4));
        }
        ...
        public void VarPShouldReturnCorrectResult()
        {
            ...
            var args = FunctionsHelper.CreateArgs(1, 2, 3, 4);
            var result = func.Execute(args, _parsingContext);
            Assert.That(1.25d, Is.EqualTo(result.Result));
        }
        ...
        public void CosShouldReturnCorrectResult()
        {
            ...
            Assert.That(-0.416146837d, Is.EqualTo(roundedResult));
        }
        ...
        public void CosHShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double)result.Result, 9);
            Assert.That(3.762195691, Is.EqualTo(roundedResult));
        }
        ...
        public void AcosShouldReturnCorrectResult()
        {
            ...
            Assert.That(1.4706, Is.EqualTo(roundedResult));
        }
        ...
        public void ACosHShouldReturnCorrectResult()
        {
            ...
            Assert.That(1.317, Is.EqualTo(roundedResult));
        }
        ...
        public void SinShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double)result.Result, 9);
            Assert.That(0.909297427, Is.EqualTo(roundedResult));
        }
        ...
        public void SinhShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double)result.Result, 9);
            Assert.That(3.626860408d, Is.EqualTo(roundedResult));
        }
        ...
        public void TanShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double)result.Result, 9);
            Assert.That(-2.185039863d, Is.EqualTo(roundedResult));
        }
        ...
        public void TanhShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double)result.Result, 9);
            Assert.That(0.96402758d, Is.EqualTo(roundedResult));
        }
        ...
        public void AtanShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double) result.Result, 9);
            Assert.That(1.471127674d, Is.EqualTo(roundedResult));
        }
        ...
        public void Atan2ShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double)result.Result, 9);
            Assert.That(1.107148718d, Is.EqualTo(roundedResult));
        }
        ...
        public void AtanhShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double)result.Result, 4);
            Assert.That(0.1003d, Is.EqualTo(roundedResult));
        }
        ...
        public void LogShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double)result.Result, 9);
            Assert.That(0.301029996d, Is.EqualTo(roundedResult));
        }
        ...
        public void LnShouldReturnCorrectResult()
        {
            ...
            Assert.That(1.60944d, Is.EqualTo(roundedResult));
        }
        ...
        public void SqrtPiShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            var roundedResult = Math.Round((double)result.Result, 9);
            Assert.That(2.506628275d, Is.EqualTo(roundedResult));
        }
        ...
        public void RounddownShouldReturnCorrectResultWithPositiveNumber()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(9.99, Is.EqualTo(result.Result));
        }
        ...
        public void RounddownShouldHandleNegativeNumDigits()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(900d, Is.EqualTo(result.Result));
        }
        ...
        public void RounddownShouldHandleZeroNumDigits()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(999d, Is.EqualTo(result.Result));
        }
        ...
        public void RoundupShouldReturnCorrectResultWithPositiveNumber()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(9.992, Is.EqualTo(result.Result));
        }
        ...
        public void RoundupShouldHandleNegativeNumDigits()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(99200d, Is.EqualTo(result.Result));
        }
        ...
        public void RoundupShouldHandleZeroNumDigits()
        {
            ...
            var args = FunctionsHelper.CreateArgs(999.999, 0);
            var result = func.Execute(args, _parsingContext);
            Assert.That(1000d, Is.EqualTo(result.Result));
        }
        ...
        public void TruncShouldReturnCorrectResult()
        {
            ...
            var result = func.Execute(args, _parsingContext);
            Assert.That(99d, Is.EqualTo(result.Result));
        }
        ...
        public void MedianShouldCalculateCorrectlyWithEvenMembers()
        {
            ...
            var args = FunctionsHelper.CreateArgs(1, 2, 3, 4);
            var result = func.Execute(args, _parsingContext);
            Assert.That(2.5d, Is.EqualTo(result.Result));
        }
        ...
        public void CountIfShouldHandleNegativeCriteria()
        {
            using (var package = new ExcelPackage())
            {
                ...
                sheet1.Calculate();
                Assert.That(1d, Is.EqualTo(sheet1.Cells["A3"].Value));
            }
        }
        [Test]
        public void Rank()
        {
            using (var p = new ExcelPackage())
            {
                ...
                Assert.That(w.GetValue(1, 2), Is.EqualTo(4D));
                Assert.That(w.GetValue(1, 3), Is.EqualTo(1D));
                Assert.That(w.GetValue(1, 4), Is.EqualTo(4.5D));
                Assert.That(w.GetValue(1, 5), Is.EqualTo(1.5D));

                Assert.That(w.GetValue(2, 2), Is.EqualTo(2D));
                Assert.That(w.GetValue(2, 3), Is.EqualTo(3D));
                Assert.That(w.GetValue(2, 4), Is.EqualTo(3.5D));
                Assert.That(w.GetValue(2, 5), Is.EqualTo(2.5D));

                Assert.That(w.GetValue(3, 2), Is.InstanceOf<ExcelErrorValue>());
                Assert.That(w.GetValue(3, 3), Is.InstanceOf<ExcelErrorValue>());
                Assert.That(w.GetValue(3, 4), Is.InstanceOf<ExcelErrorValue>());
                Assert.That(w.GetValue(3, 5), Is.InstanceOf<ExcelErrorValue>());

                Assert.That(w.GetValue(4, 2), Is.EqualTo(1D));
                Assert.That(w.GetValue(4, 3), Is.EqualTo(5D));
                Assert.That(w.GetValue(4, 4), Is.EqualTo(5D));
                Assert.That(w.GetValue(4, 5), Is.EqualTo(1D));

                Assert.That(w.GetValue(5, 4), Is.EqualTo(5.5D));
                Assert.That(w.GetValue(5, 5), Is.EqualTo(1.5D));
            }
        }
    }
    }
